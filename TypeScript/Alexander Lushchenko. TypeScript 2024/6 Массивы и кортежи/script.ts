...
const arr_02: readonly number[] = [10, 20, 30, 40, 50]
...
const arr_04: number[] = [11, 12, 13, 14, 15]
const [a, b, ...c] = arr_04
console.log(a, b, c)
...
const arr_06: (number | string)[] = [1, 2, 3, 'hello', 'ts']
console.log(arr_06)
// 2 Вариант записи
const arr_07: Array<string | number> = [...arr_06]
console.log(arr_07)

// Кортежи
const cort_01: [string, number] = ['Ilya', 20]
...
const cort_02: [string, number, number?] = ['Ilya', 20, 73]
console.log(cort_02)
...
const cort_03: [number, ...string[]] = [1, 'two', 'free', 'four']
const cort_031: readonly [number, ...string[]] = [1, 'two', 'free', 'four'] // Тогда изменить кортеж нельзя
console.log(cort_03)
